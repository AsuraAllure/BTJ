...
public class TestArrays {
    ...
    public void testAttachedArrays() {
        Assertions.assertTrue(Arrays.attachedArray(new int[] {2, 2, 3, 1}, new int[] {0, 6}));
        Assertions.assertFalse(Arrays.attachedArray(new int[] {0, 6}, new int[] {2, 2, 3, 1}));
        ...
        Assertions.assertFalse(Arrays.attachedArray(new int[] {2, 1, 3, 4}, new int[] {2, 1, 3, 4}));
    }
}
